...
// ----------------------------------------------------------------------------
// Fixture list. Discovered at run-time via list_rigs() walking todatests/
// directory indexes; authoritative canonical comes from the sibling .json
// sidecar.
...
async function run_all() {
  ...
  if (FIXTURES.length === 0) {
    ...
    FIXTURES = await list_rigs(undefined, ['.toda'])
  }
